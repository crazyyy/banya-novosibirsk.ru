...
Full change log... We always try to keep our products up-to-date and secure.
    ...
    Version 2.2.2 - 26 June 2016
        ...
        [+] You can add your translation to wp-content/languages/screets-chat/schat-{LOCAL}.mo
        [*] Textdomain changed with 'schat' from 'chatx'
        [!] Fixed online/offline issue
        
    Version 2.2.1 - 24 June 2016
        [*] Show errors in chat console when Firebase api key is wrong
    ...
    Version 2.1.1 - 27 Jan 2016
        ...
        [*] Changed admin menu icon of Chat X
    ...
    Version 2.1 - 4 January 2016
        ...
        [+] Added new hook: "scx_email_chat_subject"
    ...
    Version 2.0.3 - 3 December 2015
        ...
        [+] Added "get_users" function in scx.firebase.js
        [+] Shows "new message count" on chat button when popup is closed
        [+] Added "del_session" function in scx.firebase.js
        ...
        [*] Changed "remove_user" functions with "del_user" in scx.firebase.js
        [*] Changed "msg-remove" event with "msg-del" in scx.firebase.js
        [*] Changed "msg-remove" event with "msg-del" in scx.firebase.js
        [*] Added "get_chats" function in scx.firebase.js
