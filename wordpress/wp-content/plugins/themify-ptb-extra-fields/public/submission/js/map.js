...
(function ($) {
        ...
        $(document).ready(function(){
            if(typeof google !== 'object' || typeof google.maps !== 'object' || typeof google.maps.places === 'undefined'){
                ...
                loadScript('//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=false&sensor=false&libraries=places&callback=PTB_Submission_Map&language='+ptb_submission.lng+'&key='+ptb_extra.map_key);
            }
            else{
                PTB_Submission_Map();
            }
