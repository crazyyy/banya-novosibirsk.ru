...
class PTB_Map_View_Public {
    ...
    private function enqueue_scripts() {
       if(!wp_script_is($this->plugin_name)){
            ...
            wp_register_script($this->plugin_name,$plugin_url . 'js/ptb-map.js', array('ptb_extra'), $this->version, true);
            ...
            wp_enqueue_style($this->plugin_name, $plugin_url . 'css/ptb-map.css', array(),$this->version, 'all');
