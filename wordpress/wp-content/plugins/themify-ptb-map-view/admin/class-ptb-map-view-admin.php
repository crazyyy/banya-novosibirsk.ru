...
class PTB_Map_View_Admin {
    ...
    public function enqueue_scripts() {
        ...
        if ($screen->id != 'customize') {
            ...
            wp_enqueue_style($this->plugin_name, $pluginurl . 'admin/css/ptb-map.css', array(), $this->version, 'all');
    ...
    */
    ...
    public function ptb_ajax_get_post_type() {
        if (!empty($_POST['post_type'])) {
            ...
            $result['data']['road_type']['values'] = array(
                ...
                array('text'=>__('Terrain','ptb_map'),'value'=>'tserrain')
            );
            ...
            $enable =  array(
                array('text'=>__('Disable','ptb_map'),'value'=>'enable'),
                array('text'=>__('Enable','ptb_map'),'value'=>'disable'),
            );
    ...
    public function ptb_add_shortcodes_buttons($plugin_array) {
        ...
        $plugin_array[$this->plugin_name] = plugin_dir_url(__FILE__) . 'js/ptb-map-shortcode.js';
