...
function shopme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus3/shopme-content-types.zip',
			'required'           => false,
			'version'            => '1.0.4',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus3/indeed-smart-popup.zip',
			'required'           => false,
			'version'            => '4.6',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			'name'               => 'LayerSlider WP',
			'slug'               => 'LayerSlider',
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus3/LayerSlider.zip',
			'required'           => false,
			'version'            => '6.2.2',
			'force_activation'   => false,
			'force_deactivation' => false
		...
		array(
			...
			'slug'               => 'revslider',
			'source'             => 'http://velikorodnov.com/wordpress/sample-data/shopme/pluginus3/revslider.zip',
			'required'           => false,
			'version'            => '5.4.1',
			'force_activation'   => false,
			'force_deactivation' => false
...
//			'version'            => '3.6.3', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
